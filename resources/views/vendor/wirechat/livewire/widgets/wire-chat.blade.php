<div class="h-full ">
    ...
    x-data="{
     ...
     class ='w-full h-full bg-white border flex overflow-hidden rounded-lg'>
      <div :class="chatIsOpen && 'hidden md:grid'" class="relative  w-full h-full sm:border-r md:w-[360px] lg:w-[400px] xl:w-[450px] shrink-0 overflow-y-auto  ">
      ...
      <main
           ...
           style="contain:content;">
            ...
            <div  x-show="!show && !chatIsOpen " class="m-auto  justify-center flex gap-3 flex-col  items-center ">
                ...
                <h4 class="font-medium p-2 px-3 rounded-full font-semibold bg-gray-50">@lang('wirechat::widgets.wirechat.messages.welcome')</h4>
