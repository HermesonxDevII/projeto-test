...
<div x-data dusk="new_group_modal">
    ...
    <div
        class="relative w-full h-[410px] border  items-center justify-center overflow-auto bg-white sm:max-w-lg sm:rounded-lg">
            ...
            <form wire:submit="validateDetails()" class="flex flex-col  h-full p-4">
                ...
                <main class="my-5">
                    <div class=" my-auto space-y-2">
                        ...
                        <textarea id='description' type="text" wire:model='description' placeholder="{{__('wirechat::new.group.inputs.description.placeholder')}}" rows="4"
                            class=" w-full resize-none rounded-lg border-gray-200 focus:border-gray-200   bg-inherit outline-hidden w-full focus:outline-hidden  focus:ring-0 hover:ring-0">
                    </textarea>
                ...
                <footer class="flex gap-4 justify-end mt-auto">
                    <x-wirechat::actions.close-modal>
                        <button type="button" dusk="cancel_create_new_group_button"class="font-bold p-3 px-4 rounded-xl ">
                    ...
                    <button type="submit" :disabled="!($wire.name?.trim()?.length)" dusk="next_button"
                        ...
                        class="font-bold transition p-3 px-4 rounded-xl ">
            ...
            <header class=" sticky top-0 bg-white z-10 py-2">
                <div class="flex items-center pb-2">
                    ...
                    <button 
                        ...
                        wire:target='create'
                        class="p-2 disabled:cursor-not-allowed  ml-0 text-gray-600 rounded-full hover:text-gray-800 hover:bg-gray-50">
                     ...
                     class="flex w-full overflow-x-auto gap-3">
                        ...
                        @if ($selectedMembers)
                            ...
                            @foreach ($selectedMembers as $key => $member)
                                <li class="flex items-center text-nowrap min-w-fit px-2 py-1 text-sm font-medium text-gray-800 bg-gray-100 rounded-sm"
