<div id="group-info-modal" class="bg-white     min-h-screen">
    ...
    <footer class="flex flex-col justify-start w-full">
        ...
        @if ($authIsOwner)
            ...
            <button wire:confirm="{{ __('wirechat::chat.group.info.actions.delete_group.confirmation_message') }}" wire:click="deleteGroup"
                ...
                <p class=/60 text-sm text-gray-600/80">@lang('wirechat::chat.group.info.actions.delete_group.helper_text')</p>
            </button>
            {{-- Permissions --}}
            <div>
