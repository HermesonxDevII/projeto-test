<div class="bg-white overfo opaticy-100   min-h-screen w-full">
    ...
    <div class="">
        <section >
            ...
            <h5 class="w-full text-start py-4 bg-gray-50 px-50 px-4">
                ...
                <li class="w-full flex  p-5">
                    ...
                    <span class="w-12">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-hidden rounded-full peer 
