<div class="h-[calc(100vh_-_10rem)]  sm:h-[450px] bg-white border overflow-y-auto overflow-x-hidden  ">
    <header class=" sticky top-0 bg-white  z-10 p-2">
        <div class="flex items-center pb-2">
            ...
            <h3
                class="text-sm mx-auto font-semibold "
            >
                <span> {{__('wirechat::chat.group.add_members.heading.label')}} </span>
                {{$newTotalCount}} / {{$maxGroupMembers}}
            </h3>
            ...
            <button 
                ...
                @class([
                    'p-2 disabled:cursor-not-allowed  disabled:hover:bg-inherit ml-0 text-gray-600 rounded-full hover:text-gray-800 hover:bg-gray-50',
            ...
            >
                @if ($selectedMembers)
                    @foreach ($selectedMembers as $key => $member)
                        <li
                            class="flex items-center text-nowrap min-w-fit px-2 py-1 text-sm font-medium text-gray-800 bg-gray-100 rounded-sm"
                        ...
                        >
                            ...
                            >
                                ...
                                <span class="sr-only">Remover selo</span>
                            </button>
                        </li>
                    @endforeach
                @endif
                                ...
                                <div class="ml-auto">
                                    ...
                                    @else
                                        <svg
                                            ...
                                            height="16"
                                            fill="currentColor"
                                            class="bi bi-plus-square-dotted w-6 h-6"
                                            viewBox="0 0 16 16"
                                        >
                                            <path
