...
<header
    class="w-full  sticky inset-x-0 flex pb-[5px] pt-[7px] top-0 z-10 bg-gray-50  border-b"
>
    <div class="  flex  w-full items-center   px-2 py-2   lg:px-4 gap-2 md:gap-5 ">
        ...
        <section class="grid grid-cols-12 w-full">
            ...
            <div class="flex gap-2 items-center ml-auto col-span-1">
                ...
                >
                    <x-slot name="trigger">
                        <button class="inline-flex px-0 text-gray-700">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                    ...
                    <x-slot name="content">
                        ...
                        @else
                            <x-wirechat::dropdown-link
                                href="{{ route(WireChat::indexRouteName()) }}"
                                class="shrink-0"
                            >
                                @lang('wirechat::chat.actions.close_chat.label')
                            </x-wirechat::dropdown-link>
