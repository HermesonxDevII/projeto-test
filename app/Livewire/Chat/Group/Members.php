...
namespace App\Livewire\Chat\Group;
...
class Members extends ModalComponent
{
    ...
    public function sendMessage(Participant $participant)
    {
        ...
        $conversation = getAuthenticatedParticipant()->createConversationWith($participant->participantable);
    ...
    public function removeFromGroup(Participant $participant)
    {
        ...
        abort_unless(getAuthenticatedParticipant()->isAdminIn($this->conversation), 403, 'You do not have permission to perform this action in this group. Only admins can proceed.');
        ...
        Action::create([
            ...
            'actor_id' => getAuthenticatedParticipant()->id,  // The admin who performed the action
            'actor_type' => getAuthenticatedParticipant()->getMorphClass(),  // Assuming 'User' is the actor model
    ...
    public function render()
    {
        ...
        return view('wirechat::livewire.chat.group.members', [
            'participant' => $this->conversation->participant(getAuthenticatedParticipant()),
