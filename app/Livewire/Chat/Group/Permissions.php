...
class Permissions extends ModalComponent
{
    ...
    public function mount()
    {
        ...
        abort_unless(getAuthenticatedParticipant()->belongsToConversation($this->conversation), 403, 'You do not have permission to access this resource');

        abort_unless($this->conversation->isOwner(getAuthenticatedParticipant()), 403, 'You do not have permission to edit group permissions');
