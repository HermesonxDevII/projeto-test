...
class Group extends ModalComponent
{
    ...
    public function create()
    {
        ...
        // create group
        $conversation = getAuthenticatedParticipant()->createGroup($this->name, $this->description, $this->photo);
    ...
    public function mount()
    {
        ...
        abort_unless(getAuthenticatedParticipant()->canCreateGroups(), 403, 'You do not have permission to create groups.');
